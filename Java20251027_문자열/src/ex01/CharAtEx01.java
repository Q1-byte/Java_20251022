...
public class CharAtEx01 {
	...
	public static void main(String[] args) {
		...
		//"자바 프로그래밍" 문장에서 "자바"를 "파이썬"으로 변경해서 문자열 생성
		...
		//index 4번째 위치에서 전부 다 문자 추출
		String sub2 = subject.substring(4);
		System.out.println(sub2);
		
		//index 4번째 위치에서 6번 전까지 추출 즉, 4~5 추출
		...
		//만약 -1이 추출된다면 해당하는 단어가 문자열에 없다는 것
		...
		String s = "대한";
		String s2 = "민국";
		//s 가지고있는 "대한"에 s2가 가지고있는 "민국"을 합쳐서 새로운 문자열 "대한민국" 생성
